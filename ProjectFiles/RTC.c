...
receive_multiple(uint8_t *b, uint8_t n){
	...
	//define master e slave e tipo de opera��o
	I2CMasterSlaveAddrSet(I2C0_BASE, TMP006_I2CADDR, I2C_READ);
...
RTC_init(){
	...
	//preaparando para inicializ�o dos pinos do I2C
	...
	I2CIntRegister(I2C0_BASE, RTC_int_callback);
